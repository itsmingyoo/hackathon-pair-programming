import React, { JSXElementConstructor, ReactElement, ReactNode, ReactPortal, Dispatch, SetStateAction } from 'react';
    ...
    return (
        <div id="profile-main">
            <div id="profile-header">
                ...
                <button id="edit-profile-mode" onClick={() => alert('Feature coming soon!')}>
                    DM
                </button>
                <button id="edit-profile-mode" onClick={() => alert('This is a preview, you cannot follow yourself')}>
                    Follow
                </button>
                <button id="edit-profile-mode" onClick={() => setEditMode(true)}>
                    Edit Profile
                </button>
            </div>
                        ...
                        <div id="user-socials-container">
                            <div className="user-socials">
                                <div className="up-preview">
                                    ...
                                    >
                                        <img src={LinkedInIcon} alt="telskjtrs" />
                                    </button>
                                    {/* Porfolio */}
                                    <button
                                        className="card2"

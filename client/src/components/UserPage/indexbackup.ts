...
//                 // Check if res.payload is of type User before proceeding
//                 if (res.payload && typeof res.payload === 'object' && 'id' in res.payload) {
//                     const user = await dispatch(getFollowing(res.payload as User));
//                     console.log('User data:', user);
//                 } else {
//                     console.log('res.payload is not a User object');
//                 }
//             }
//         }
//         once();
...
//                                     <div>Followers</div>
//                                 </div>
//                                 <button>Get TargetUser Following</button>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
